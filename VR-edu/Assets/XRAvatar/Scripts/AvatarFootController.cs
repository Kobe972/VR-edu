...
public class AvatarFootController : NetworkBehaviour
{
    ...
    [SerializeField] private Vector3 raycastOffsetRight;
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        bool isRightFootDown = Physics.Raycast(rightFootPos + this.raycastOffsetRight, Vector3.down, out hitRightFoot);
