...
private void Update()
    {
        ...
        f = mirrorCamera.farClipPlane+111;                                             //镜像摄像机的远剪切面的距离
        va = pa - pe;                                                               //从镜像摄像机到左下角
        vb = pb - pe;                                                               //从镜像摄像机到右下角
        vc = pc - pe;                                                               //从镜像摄像机到左上角
        vr = pb - pa;                                                               //屏幕的右侧旋转轴
    ...
    //旋转矩阵
      ...
      //估值 —— 三目简写
      mirrorCamera.fieldOfView = mirrorCamera.aspect >= 1.0 ? Mathf.Rad2Deg *
    ...
    //      mirrorCamera.projectionMatrix = mirrorCamera.projectionMatrix * Matrix4x4.Scale(scale);
    //  }   
    // void OnPreRender () {
